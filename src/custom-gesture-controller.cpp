...
CustomGestureController::CustomGestureController(const WindowSystem &windowSystem) : windowSystem(windowSystem) {}
...
void CustomGestureController::onGestureUpdate(std::unique_ptr<Gesture> gesture) {
